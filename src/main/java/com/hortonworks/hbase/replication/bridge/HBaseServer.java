...
import org.apache.hadoop.hbase94.io.WritableWithSize;
import org.apache.hadoop.hbase94.ipc.CallerDisconnectedException;
import org.apache.hadoop.hbase94.ipc.HBaseRPCErrorHandler;
import org.apache.hadoop.hbase94.ipc.HBaseRpcMetrics;
import org.apache.hadoop.hbase94.ipc.RequestContext;
import org.apache.hadoop.hbase94.ipc.RpcCallContext;
import org.apache.hadoop.hbase94.ipc.ServerNotRunningYetException;
import org.apache.hadoop.hbase94.ipc.VersionedProtocol;
import org.apache.hadoop.hbase94.monitoring.MonitoredRPCHandler;
import org.apache.hadoop.hbase94.monitoring.TaskMonitor;
import org.apache.hadoop.hbase94.security.User;
import org.apache.hadoop.hbase94.util.ByteBufferOutputStream;
import org.apache.hadoop.hbase94.util.Bytes;
import org.apache.hadoop.hbase94.util.SizeBasedThrottler;
  ...
  protected class Connection {
    ...
    private void processHeader() throws IOException {
      ...
      try {
        ...
        if (protocolClassName == null || protocolClassName.equalsIgnoreCase("org.apache.hadoop.hbase.ipc.HRegionInterface")) {
          protocolClassName = "org.apache.hadoop.hbase94.ipc.HRegionInterface";
        }
